...
submityaml.py -k apikey.txt qemu.yaml

echo "Submit and wait for v2/pipeline Zephyr qemu-cortex-m3 crypto tests to complete"
submityaml.py -k apikey.txt qemu-cortex-m3-zephyr-crypto-tests-set1.yaml 
submityaml.py -k apikey.txt qemu-cortex-m3-zephyr-crypto-tests-set2.yaml
